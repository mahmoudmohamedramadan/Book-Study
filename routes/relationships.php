...
Route::get('relationships', function () {
    ...
    /*
        NOTICE THAT WE CALLED phoneNumber AS A PROPERTY NOT A METHOD, IF WE CALLED IT AS APROPERTY IT WILL RETURN A FULL ELOQUENT INSTANCE AND THE METHOD WILL RETURN COLLECTION INSTEAD OF MODEL INSTANCE...
